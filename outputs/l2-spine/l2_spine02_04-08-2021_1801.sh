...
net add vlan 2 ip address 10.2.2.2/24
#
### Add VRR to VLAN 2
...
net add bgp neighbor 10.2.2.10 peer-group ebgp_leaf
net add bgp neighbor 10.2.2.20 peer-group ebgp_leaf
net add bgp neighbor 10.2.2.30 peer-group ebgp_leaf
