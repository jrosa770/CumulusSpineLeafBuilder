...
### Add Admin Lookpback
net add loopback lo ip address 10.255.1.2/32
#
### OOB MGMT
net add interface eth0 ip address 10.1.0.102/24
#
...
net add interface swp1 ip address 10.254.1.3/31
net add interface swp1 alias spine01-swp2
#
### Enable L3 on interfaces swp2
net add interface swp2 ip address 10.254.2.3/31
net add interface swp2 alias spine02-swp2
#
...
net add bgp neighbor 10.254.1.2 remote-as external
net add bgp neighbor 10.254.2.2 remote-as external
net add bgp network 10.255.1.2/32
net add bgp network 10.254.1.2/31
net add bgp network 10.254.2.2/31
